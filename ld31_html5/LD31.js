...
ApplicationMain.preload = function() {
	...
	ApplicationMain.loadBinary("assets/data/level.tsx");
	ApplicationMain.loadBinary("assets/data/level1.tmx");
	ApplicationMain.loadBinary("assets/data/level2.tmx");
	ApplicationMain.loadBinary("assets/data/level3.tmx");
	ApplicationMain.loadBinary("assets/data/level4.tmx");
	ApplicationMain.loadBinary("assets/data/objecttypes.xml");
	ApplicationMain.loadFile("assets/images/bg.png");
	ApplicationMain.loadFile("assets/images/btn_exit.png");
	ApplicationMain.loadFile("assets/images/btn_menu.png");
	ApplicationMain.loadFile("assets/images/btn_mute.png");
	ApplicationMain.loadFile("assets/images/btn_play.png");
	ApplicationMain.loadFile("assets/images/btn_restart.png");
	ApplicationMain.loadBinary("assets/images/entities.json");
	ApplicationMain.loadFile("assets/images/entities.png");
	ApplicationMain.loadFile("assets/images/gameover.png");
	ApplicationMain.loadFile("assets/images/gamewon.png");
	ApplicationMain.loadFile("assets/images/info.png");
	ApplicationMain.loadFile("assets/images/intro.png");
	ApplicationMain.loadFile("assets/images/menu_bg.png");
	ApplicationMain.loadFile("assets/images/say_huh.png");
	ApplicationMain.loadFile("assets/images/say_keys.png");
	ApplicationMain.loadFile("assets/images/say_wtf.png");
	ApplicationMain.loadFile("assets/images/say_yay.png");
	ApplicationMain.loadFile("assets/images/tex_base.png");
	ApplicationMain.loadSound("assets/sounds/click.wav");
	ApplicationMain.loadSound("assets/sounds/collidelock.wav");
	ApplicationMain.loadSound("assets/sounds/gameover.wav");
	ApplicationMain.loadSound("assets/sounds/gamewon.wav");
	ApplicationMain.loadSound("assets/sounds/jump.wav");
	ApplicationMain.loadSound("assets/sounds/keypicked.wav");
	ApplicationMain.loadSound("assets/sounds/lockpicked.wav");
	ApplicationMain.loadSound("assets/sounds/wrongorb.wav");
...
var org = {};
org.chaoneurogue = {};
org.chaoneurogue.ld31 = {};
org.chaoneurogue.ld31.Main = function() {
	this.startFullscreen = false;
	this.skipSplash = false;
	this.framerate = 60;
	this.zoom = -1;
	this.initialState = org.chaoneurogue.ld31.PlayState;
	this.gameHeight = 640;
	this.gameWidth = 800;
	flash.display.Sprite.call(this);
	if(this.get_stage() != null) this.init(); else this.addEventListener("addedToStage",$bind(this,this.init));
};
$hxClasses["org.chaoneurogue.ld31.Main"] = org.chaoneurogue.ld31.Main;
org.chaoneurogue.ld31.Main.__name__ = ["org","chaoneurogue","ld31","Main"];
org.chaoneurogue.ld31.Main.main = function() {
	flash.Lib.get_current().addChild(new org.chaoneurogue.ld31.Main());
};
org.chaoneurogue.ld31.Main.__super__ = flash.display.Sprite;
org.chaoneurogue.ld31.Main.prototype = $extend(flash.display.Sprite.prototype,{
	gameWidth: null
	,gameHeight: null
	,initialState: null
	,zoom: null
	...
	,__class__: org.chaoneurogue.ld31.Main
});
var DocumentClass = function() {
	org.chaoneurogue.ld31.Main.call(this);
};
$hxClasses["DocumentClass"] = DocumentClass;
DocumentClass.__name__ = ["DocumentClass"];
DocumentClass.__super__ = org.chaoneurogue.ld31.Main;
DocumentClass.prototype = $extend(org.chaoneurogue.ld31.Main.prototype,{
	get_stage: function() {
...
var DefaultAssetLibrary = function() {
	...
	this.add("assets/data/level.tsx",openfl.AssetType.TEXT);
	this.add("assets/data/level1.tmx",openfl.AssetType.TEXT);
	this.add("assets/data/level2.tmx",openfl.AssetType.TEXT);
	this.add("assets/data/level3.tmx",openfl.AssetType.TEXT);
	this.add("assets/data/level4.tmx",openfl.AssetType.TEXT);
	this.add("assets/data/objecttypes.xml",openfl.AssetType.TEXT);
	this.add("assets/images/bg.png",openfl.AssetType.IMAGE);
	this.add("assets/images/btn_exit.png",openfl.AssetType.IMAGE);
	this.add("assets/images/btn_menu.png",openfl.AssetType.IMAGE);
	this.add("assets/images/btn_mute.png",openfl.AssetType.IMAGE);
	this.add("assets/images/btn_play.png",openfl.AssetType.IMAGE);
	this.add("assets/images/btn_restart.png",openfl.AssetType.IMAGE);
	this.add("assets/images/entities.json",openfl.AssetType.TEXT);
	this.add("assets/images/entities.png",openfl.AssetType.IMAGE);
	this.add("assets/images/gameover.png",openfl.AssetType.IMAGE);
	this.add("assets/images/gamewon.png",openfl.AssetType.IMAGE);
	this.add("assets/images/info.png",openfl.AssetType.IMAGE);
	this.add("assets/images/intro.png",openfl.AssetType.IMAGE);
	this.add("assets/images/menu_bg.png",openfl.AssetType.IMAGE);
	this.add("assets/images/say_huh.png",openfl.AssetType.IMAGE);
	this.add("assets/images/say_keys.png",openfl.AssetType.IMAGE);
	this.add("assets/images/say_wtf.png",openfl.AssetType.IMAGE);
	this.add("assets/images/say_yay.png",openfl.AssetType.IMAGE);
	this.add("assets/images/tex_base.png",openfl.AssetType.IMAGE);
	this.add("assets/sounds/click.wav",openfl.AssetType.SOUND);
	this.add("assets/sounds/collidelock.wav",openfl.AssetType.SOUND);
	this.add("assets/sounds/gameover.wav",openfl.AssetType.SOUND);
	this.add("assets/sounds/gamewon.wav",openfl.AssetType.SOUND);
	this.add("assets/sounds/jump.wav",openfl.AssetType.SOUND);
	this.add("assets/sounds/keypicked.wav",openfl.AssetType.SOUND);
	this.add("assets/sounds/lockpicked.wav",openfl.AssetType.SOUND);
	this.add("assets/sounds/wrongorb.wav",openfl.AssetType.SOUND);
...
flixel.addons.editors.tiled.TiledMap = function(Data) {
	...
	var source = null;
	var node = null;
	if(typeof(Data) == "string") source = new haxe.xml.Fast(Xml.parse(openfl.Assets.getText(Data))); else if(js.Boot.__instanceof(Data,Xml)) source = new haxe.xml.Fast(Data); else throw "Unknown TMX map format";
	...
	while( $it1.hasNext() ) {
		var node2 = $it1.next();
		auxNode = node2;
		if(auxNode.has.resolve("source")) {
			var sourcePath = auxNode.att.resolve("source");
			if(typeof(sourcePath) == "string" && typeof(Data) == "string") {
				var dataStr;
				dataStr = js.Boot.__cast(Data , String);
				if(dataStr != null) {
					var assetPath;
					assetPath = js.Boot.__cast(Data , String);
					assetPath = assetPath.substring(0,assetPath.lastIndexOf("/"));
					sourcePath = assetPath + "/" + sourcePath;
					auxNode = new haxe.xml.Fast(Xml.parse(openfl.Assets.getText(sourcePath)));
					auxNode = auxNode.node.resolve("tileset");
				}
			}
		}
		if(auxNode.has.resolve("name")) {
			name = auxNode.att.resolve("name");
			if(!this.noLoadHash.exists(name)) {
				var value = new flixel.addons.editors.tiled.TiledTileSet(auxNode);
	...
	while( $it2.hasNext() ) {
		var node3 = $it2.next();
		if(node3.has.resolve("name")) {
			name = node3.att.resolve("name");
			if(!this.noLoadHash.exists(name)) this.layers.push(new flixel.addons.editors.tiled.TiledLayer(node3,this));
		}
	}
	...
	while( $it3.hasNext() ) {
		...
		if(!this.noLoadHash.exists(name)) this.objectGroups.push(new flixel.addons.editors.tiled.TiledObjectGroup(node4,this));
	}
};
...
flixel.addons.editors.tiled.TiledObject.prototype = {
	...
	,getPoints: function(Node) {
		...
		while(_g < pointsStr.length) {
			...
			++_g;
			pair = p.split(",");
			this.points.push(flixel.util.FlxPoint.get(Std.parseFloat(pair[0]),Std.parseFloat(pair[1])));
		}
	}
...
flixel.addons.editors.tiled.TiledObjectGroup = function(Source,Parent) {
	...
	while( $it1.hasNext() ) {
		var node2 = $it1.next();
		this.objects.push(new flixel.addons.editors.tiled.TiledObject(node2,this));
	}
};
...
flixel.effects.FlxSpriteFilter = function(Sprite,WidthIncrease,HeightIncrease) {
	if(HeightIncrease == null) HeightIncrease = 0;
	if(WidthIncrease == null) WidthIncrease = 0;
	this.heightInc = 0;
	this.widthInc = 0;
	if(js.Boot.__instanceof(Sprite,flixel.text.FlxText)) throw "FlxText objects aren't supported. Use FlxText's filter functionality";
	this.sprite = Sprite;
	this.cachedDestroy = this.sprite.cachedGraphics.destroyOnNoUse;
	this.sprite.cachedGraphics.set_destroyOnNoUse(false);
	this.backupGraphics = this.sprite.cachedGraphics;
	this.backupRegion = this.sprite.region;
	this.frameWidth = this.sprite.frameWidth;
	this.frameHeight = this.sprite.frameHeight;
	this.filters = [];
	if(this.backupGraphics.data != null && (this.backupRegion.tileWidth == 0 && this.backupRegion.tileHeight == 0)) throw "FlxSprites with full atlas animation aren't supported";
	var frame = this.sprite.animation.frameIndex;
	var currAnim = this.sprite.animation.get_name();
	if(currAnim != null) frame = this.sprite.animation.get_curAnim().curFrame;
	var animator = new flixel.animation.FlxAnimationController(this.sprite);
	animator.copyFrom(this.sprite.animation);
	this.setClipping(this.sprite.frameWidth + WidthIncrease,this.sprite.frameHeight + HeightIncrease);
	this.sprite.animation.destroy();
	this.sprite.animation = animator;
	if(currAnim != null) this.sprite.animation.play(currAnim,true,frame); else this.sprite.animation.set_frameIndex(frame);
};
$hxClasses["flixel.effects.FlxSpriteFilter"] = flixel.effects.FlxSpriteFilter;
flixel.effects.FlxSpriteFilter.__name__ = ["flixel","effects","FlxSpriteFilter"];
flixel.effects.FlxSpriteFilter.prototype = {
	sprite: null
	,backupGraphics: null
	,backupRegion: null
	,filters: null
	...
	,destroy: function() {
		this.filters = null;
		this.sprite = null;
		if(this.backupGraphics != null) this.backupGraphics.set_destroyOnNoUse(this.cachedDestroy);
		this.backupGraphics = null;
	...
	,setClipping: function(Width,Height) {
		this.width = Width;
		this.height = Height;
		this.widthInc = this.width - this.backupRegion.tileWidth;
		this.heightInc = this.height - this.backupRegion.tileHeight;
		var numRows = this.backupRegion.get_numRows();
		var numCols = this.backupRegion.get_numCols();
		var newWidth = numCols * this.width + numCols - 1;
		var newHeight = numRows * this.height + numRows - 1;
		this.pixels = new flash.display.BitmapData(newWidth,newHeight,true,0);
		this.regenBitmapData(false);
		var _g = this.sprite;
		_g.set_x(_g.x - (this.widthInc / 2 | 0));
		var _g1 = this.sprite;
		_g1.set_y(_g1.y - (this.heightInc / 2 | 0));
		var cached = flixel.FlxG.bitmap.addWithSpaces(this.pixels,0,0,1,1,false,null);
		var textureReg = new flixel.util.loaders.TextureRegion(cached,0,0,this.width,this.height,1,1,this.pixels.component.width,this.pixels.component.height);
		this.sprite.loadGraphic(textureReg,this.sprite.frames > 1,this.width,this.height);
	}
	,regenBitmapData: function(fill) {
		if(fill == null) fill = true;
		this.pixels.lock();
		if(fill) this.pixels.fillRect(this.pixels.rect,0);
		var numRows = this.backupRegion.get_numRows();
		var numCols = this.backupRegion.get_numCols();
		var frameOffsetX = this.widthInc / 2 | 0;
		var frameOffsetY = this.heightInc / 2 | 0;
		flixel.effects.FlxSpriteFilter.helperRect.width = this.backupRegion.tileWidth;
		flixel.effects.FlxSpriteFilter.helperRect.height = this.backupRegion.tileHeight;
		var _g = 0;
		while(_g < numCols) {
			var i = _g++;
			flixel.effects.FlxSpriteFilter.helperRect.x = this.backupRegion.startX + i * (this.backupRegion.tileWidth + this.backupRegion.spacingX);
			flixel.effects.FlxSpriteFilter.helperPoint.x = this.backupRegion.startY + i * (this.width + 1) + frameOffsetX;
			var _g1 = 0;
			while(_g1 < numRows) {
				var j = _g1++;
				flixel.effects.FlxSpriteFilter.helperRect.y = j * (this.backupRegion.tileHeight + this.backupRegion.spacingY);
				flixel.effects.FlxSpriteFilter.helperPoint.y = j * (this.height + 1) + frameOffsetY;
				this.pixels.copyPixels(this.backupGraphics.bitmap,flixel.effects.FlxSpriteFilter.helperRect,flixel.effects.FlxSpriteFilter.helperPoint);
			}
		}
		this.pixels.unlock();
	}
	,addFilter: function(filter,regenPixels) {
		if(regenPixels == null) regenPixels = true;
		this.filters.push(filter);
		if(regenPixels) this.applyFilters();
	}
	,applyFilters: function() {
		this.regenBitmapData();
		flixel.effects.FlxSpriteFilter.helperPoint.setTo(0,0);
		var _g = 0;
		var _g1 = this.filters;
		while(_g < _g1.length) {
			var filter = _g1[_g];
			++_g;
			this.pixels.applyFilter(this.pixels,this.pixels.rect,flixel.effects.FlxSpriteFilter.helperPoint,filter);
		}
		this.sprite.cachedGraphics.get_tilesheet().destroyFrameBitmapDatas();
		this.sprite.dirty = true;
	}
	,removeFilter: function(filter,regenPixels) {
		if(regenPixels == null) regenPixels = true;
		if(this.filters.length == 0 || filter == null) return;
		HxOverrides.remove(this.filters,filter);
		if(regenPixels) this.applyFilters();
	}
	,removeAllFilters: function(regenPixels) {
		if(regenPixels == null) regenPixels = true;
		if(this.filters.length == 0) return;
		while(this.filters.length != 0) this.filters.pop();
		if(regenPixels) this.applyFilters();
	}
	,__class__: flixel.effects.FlxSpriteFilter
};
...
org.chaoneurogue.world = {};
org.chaoneurogue.world.Entity = function(X,Y,SimpleGraphic) {
	if(Y == null) Y = 0;
	if(X == null) X = 0;
	this.disabled = false;
	this.name = "";
...
$hxClasses["org.chaoneurogue.world.Entity"] = org.chaoneurogue.world.Entity;
org.chaoneurogue.world.Entity.__name__ = ["org","chaoneurogue","world","Entity"];
org.chaoneurogue.world.Entity.__super__ = flixel.FlxSprite;
org.chaoneurogue.world.Entity.prototype = $extend(flixel.FlxSprite.prototype,{
	tiledObj: null
	,game: null
	,packerData: null
	,name: null
	,disabled: null
	,update: function() {
		if(org.chaoneurogue.world.Entity.paused) return;
		if(this.disabled) return;
		flixel.FlxSprite.prototype.update.call(this);
	}
	,load: function(obj,game) {
		this.tiledObj = obj;
		this.name = obj.name;
		this.game = game;
		if(obj.custom.keys.exists("atlas")) {
			var srcStr = "assets/images/" + obj.custom.keys.get("atlas");
			this.packerData = new org.chaoneurogue.utils.MyTexturePackerData(srcStr + ".json",srcStr + ".png");
			this.loadGraphicFromTexture(this.packerData,false,obj.custom.keys.get("key"));
			var r = this.packerData.getFrameRectangle(obj.custom.keys.get("key"));
			this.set_width(r.width);
			this.set_height(r.height);
			this.offset.set(-((r.width - this.frameWidth) * 0.5),-((r.height - this.frameHeight) * 0.5));
			this.origin.set(this.frameWidth * 0.5,this.frameHeight * 0.5);
		}
		this.setPosition(obj.x,obj.y - this.get_height());
		this.resolveWorld();
	}
	,resolveWorld: function() {
	}
	,startFadeIn: function(time,callback) {
		this.set_alpha(0);
		if(callback != null) flixel.tweens.FlxTween.tween(this,{ alpha : 1},time,{ type : 8, ease : flixel.tweens.FlxEase.backIn, complete : callback}); else flixel.tweens.FlxTween.tween(this,{ alpha : 1},time,{ type : 8, ease : flixel.tweens.FlxEase.backIn});
		this.scale.set();
		flixel.tweens.FlxTween.tween(this.scale,{ x : 1, y : 1},time,{ type : 8, ease : flixel.tweens.FlxEase.backIn});
	}
	,startFadeOut: function(time,callback) {
		this.set_alpha(1);
		if(callback != null) flixel.tweens.FlxTween.tween(this,{ alpha : 0},time,{ type : 8, ease : flixel.tweens.FlxEase.backOut, complete : callback}); else flixel.tweens.FlxTween.tween(this,{ alpha : 0},time,{ type : 8, ease : flixel.tweens.FlxEase.backOut});
		this.scale.set(1,1);
		flixel.tweens.FlxTween.tween(this.scale,{ x : 0, y : 0},time,{ type : 8, ease : flixel.tweens.FlxEase.backOut});
	}
	...
	,setDisabled: function(value) {
		if(value) {
			...
			this.drag.set_x(this.drag.set_y(0));
		} else {
			this.acceleration.set_y(org.chaoneurogue.world.Entity.gravity);
			this.drag.set(Std.parseFloat(this.tiledObj.custom.keys.get("dragX")),Std.parseFloat(this.tiledObj.custom.keys.get("dragX")));
		}
		this.set_solid(!value);
		this.set_immovable(value);
		this.disabled = value;
	}
	,die: function() {
		this.setDisabled(true);
	}
	,__class__: org.chaoneurogue.world.Entity
});
org.chaoneurogue.characters = {};
org.chaoneurogue.characters.Enemy = function(X,Y,SimpleGraphic) {
	if(Y == null) Y = 0;
	if(X == null) X = 0;
	this.speed = 200;
	org.chaoneurogue.world.Entity.call(this,X,Y,SimpleGraphic);
	this.acceleration.set_y(org.chaoneurogue.world.Entity.gravity);
};
$hxClasses["org.chaoneurogue.characters.Enemy"] = org.chaoneurogue.characters.Enemy;
org.chaoneurogue.characters.Enemy.__name__ = ["org","chaoneurogue","characters","Enemy"];
org.chaoneurogue.characters.Enemy.__super__ = org.chaoneurogue.world.Entity;
org.chaoneurogue.characters.Enemy.prototype = $extend(org.chaoneurogue.world.Entity.prototype,{
	speed: null
	,update: function() {
		if(org.chaoneurogue.world.Entity.paused) return;
		org.chaoneurogue.world.Entity.prototype.update.call(this);
		this.updateCollisions();
	}
	,resolveWorld: function() {
		this.game.addEnemy(this);
	}
	,load: function(obj,game) {
		org.chaoneurogue.world.Entity.prototype.load.call(this,obj,game);
		this.set_facing(1);
		if(this.tiledObj.gid & -2147483648) this.set_facing(16);
		this._facingFlip.set(1,{ x : false, y : false});
		this._facingFlip.set(16,{ x : true, y : false});
		this.speed = Std.parseFloat(this.tiledObj.custom.keys.get("speed"));
		this.velocity.set_x(this.facing == 16?this.speed:-this.speed);
	}
	,onNextLevel: function() {
	...
	,updateCollisions: function() {
		var touching = flixel.FlxG.overlap(this,this.game.tiles,$bind(this,this.onWallCollision),flixel.FlxObject.separate);
		if(!touching) this.reverseDirection();
		flixel.FlxG.overlap(this,this.game.locks,$bind(this,this.onWallCollision),flixel.FlxObject.separate);
	}
	...
	,onWallCollision: function(o1,o2) {
	...
	,die: function() {
		org.chaoneurogue.world.Entity.prototype.die.call(this);
		flixel.tweens.FlxTween.tween(this,{ alpha : 0},0.4,{ type : 8, ease : flixel.tweens.FlxEase.backOut});
		flixel.tweens.FlxTween.tween(this.scale,{ x : 0, y : 0},0.4,{ type : 8, ease : flixel.tweens.FlxEase.backOut, complete : $bind(this,this.onDied)});
	}
	,onDied: function(t) {
		this.game.onEnemyDied(this);
	}
	,__class__: org.chaoneurogue.characters.Enemy
});
org.chaoneurogue.characters.Player = function(X,Y,SimpleGraphic) {
	if(Y == null) Y = 0;
	if(X == null) X = 0;
	this.sayTimer = new flixel.util.FlxTimer();
	this.onStairs = false;
	this.keyLocksPicked = new Array();
	this.jumpImpulse = -240;
	this.speed = 200;
	this.ladderState = false;
	this.jumping = false;
	this.soundTimer = new flixel.util.FlxTimer();
	...
	this.down = false;
	this.up = false;
	this.sayAssets = ["assets/images/say_keys.png","assets/images/say_huh.png","assets/images/say_wtf.png","assets/images/say_yay.png"];
	org.chaoneurogue.world.Entity.call(this,X,Y,SimpleGraphic);
};
$hxClasses["org.chaoneurogue.characters.Player"] = org.chaoneurogue.characters.Player;
org.chaoneurogue.characters.Player.__name__ = ["org","chaoneurogue","characters","Player"];
org.chaoneurogue.characters.Player.__super__ = org.chaoneurogue.world.Entity;
org.chaoneurogue.characters.Player.prototype = $extend(org.chaoneurogue.world.Entity.prototype,{
	sayAssets: null
	,saySprite: null
	,up: null
	,down: null
	...
	,load: function(obj,game) {
		org.chaoneurogue.world.Entity.prototype.load.call(this,obj,game);
		this.set_facing(16);
		if(this.tiledObj.gid & -2147483648) this.set_facing(1);
		this._facingFlip.set(1,{ x : true, y : false});
		this._facingFlip.set(16,{ x : false, y : false});
		this.acceleration.set_y(420);
		this.speed = Std.parseFloat(this.tiledObj.custom.keys.get("speed"));
		this.drag.set(Std.parseFloat(this.tiledObj.custom.keys.get("dragX")),Std.parseFloat(this.tiledObj.custom.keys.get("dragX")));
	}
	,update: function() {
		if(org.chaoneurogue.world.Entity.paused) return;
		org.chaoneurogue.world.Entity.prototype.update.call(this);
		if(this.saySprite != null) this.saySprite.setPosition(this.x + this._halfWidth,this.y - this.get_height());
		this.updateCollisions();
		this.up = flixel.FlxG.keys.checkKeyStatus(["UP","W"],1);
		this.down = flixel.FlxG.keys.checkKeyStatus(["DOWN","S"],1);
		this.left = flixel.FlxG.keys.checkKeyStatus(["LEFT","A"],1);
		this.right = flixel.FlxG.keys.checkKeyStatus(["RIGHT","D"],1);
		this.jump = flixel.FlxG.keys.checkKeyStatus(["SPACE"],2);
		if(this.up && this.down) this.up = this.down = false;
		if(this.left && this.right) this.left = this.right = false;
		this.movement();
	}
	,movement: function() {
		if(this.left || this.right) {
			this.velocity.set_x(this.speed * (this.left?-1:1));
			if(this.left) this.set_facing(1); else this.set_facing(16);
		} else this.velocity.set_x(0);
		if(this.ladderState) {
			if(this.up) this.velocity.set_y(-this.speed); else if(this.down) this.velocity.set_y(this.speed);
		} else if(this.jump && this.velocity.y == 0) {
			this.velocity.set_y(this.jumpImpulse);
			this.jumping = true;
			flixel.FlxG.sound.play("assets/sounds/jump.wav");
		}
		if(this.onStairs) {
			if(!this.ladderState && (this.up || this.down)) {
				this.acceleration.set_y(0);
				this.velocity.set_y(this.speed * (this.up?-1:1));
				this.ladderState = true;
			}
		} else if(this.ladderState) {
			this.ladderState = false;
			this.acceleration.set_y(org.chaoneurogue.world.Entity.gravity);
	...
	,updateCollisions: function() {
		org.chaoneurogue.world.Entity.prototype.updateCollisions.call(this);
		flixel.FlxG.overlap(this,this.game.tiles,null,flixel.FlxObject.separate);
		var wasOnStairs = this.onStairs;
		this.onStairs = this.game.stairs.overlapsWithCallback(this,$bind(this,this.onOverlap));
		flixel.FlxG.overlap(this,this.game.keys,$bind(this,this.onKeyPicked));
		flixel.FlxG.overlap(this,this.game.locks,$bind(this,this.onLockCollision));
		flixel.FlxG.overlap(this,this.game.goal,$bind(this,this.onGoalCollision));
		flixel.FlxG.overlap(this,this.game.ladders,$bind(this,this.onLadderCollision),$bind(this,this.processLadderCollision));
		flixel.FlxG.overlap(this,this.game.enemies,$bind(this,this.onEnemyCollision));
	}
	,onLadderCollision: function(o1,o2) {
	}
	,processLadderCollision: function(o1,o2) {
		var l;
		l = js.Boot.__cast(o2 , org.chaoneurogue.world.items.LadderTop);
		if(flixel.FlxG.keys.checkKeyStatus(["S","DOWN"],1)) {
			this.acceleration.set_y(0);
			this.velocity.set_y(this.speed);
			return false;
		} else return flixel.FlxObject.separate(o1,o2);
	}
	,onKeyPicked: function(o1,o2) {
		var k;
		k = js.Boot.__cast(o2 , org.chaoneurogue.world.items.Key);
		if(k != null) {
			if(HxOverrides.indexOf(this.keyLocksPicked,k.lockName,0) == -1) {
				this.keyLocksPicked.push(k.lockName);
				flixel.FlxG.sound.play("assets/sounds/keypicked.wav");
			}
			this.game.removeKey(k);
		}
	}
	,onLockCollision: function(o1,o2) {
		var l;
		l = js.Boot.__cast(o2 , org.chaoneurogue.world.items.Lock);
		if(l != null) {
			var i = HxOverrides.indexOf(this.keyLocksPicked,l.name,0);
			if(i != -1) {
				this.keyLocksPicked.splice(i,1);
				this.game.removeLock(l);
				flixel.FlxG.sound.play("assets/sounds/lockpicked.wav");
			} else {
				flixel.FlxObject.separate(l,this);
				if(!this.soundlock) {
					flixel.FlxG.sound.play("assets/sounds/collidelock.wav");
					this.soundlock = true;
					this.soundTimer.start(0.5,$bind(this,this.onSoundTimer));
				}
			}
		}
	}
	,onSoundTimer: function(t) {
		this.soundlock = false;
		this.soundTimer.cancel();
	}
	,onGoalCollision: function(o1,o2) {
		var g;
		g = js.Boot.__cast(o2 , org.chaoneurogue.world.items.Goal);
		if(g != null) this.game.onNextLevel();
	}
	,doFlxGOverlap: function(o1,o2) {
		return false;
	}
	,onOverlap: function(v1,v2) {
		var tile;
		tile = js.Boot.__cast(v1 , flixel.tile.FlxTile);
		if(tile != null && tile.index == 2) {
			var overlapFound = this.x + this.get_width() > tile.x && this.x < tile.x + tile.get_width() && this.y + this.get_height() > tile.y && this.y < tile.y + tile.get_height();
			return overlapFound;
		}
		return false;
	}
	...
	,onEnemyCollision: function(o1,o2) {
		var e;
		e = js.Boot.__cast(o2 , org.chaoneurogue.characters.Enemy);
		if(e == null) return;
		if(o2.y - o1.y > 5 && Math.abs(o2.x - o1.x) < o2.get_width() * 0.85) e.die(); else this.die();
	}
	,die: function() {
		org.chaoneurogue.world.Entity.prototype.die.call(this);
		flixel.tweens.FlxTween.tween(this,{ alpha : 0},0.4,{ type : 8, ease : flixel.tweens.FlxEase.backOut});
	...
	,say: function(id) {
		this.saySprite = new flixel.FlxSprite(this.x + this._halfWidth,this.y - this.get_height(),this.sayAssets[id]);
		this.sayTimer.start(1,$bind(this,this.onSayFinished));
		this.game.add(this.saySprite);
	}
	,onSayFinished: function(tween) {
		this.sayTimer.cancel();
		this.game.remove(this.saySprite);
		this.saySprite.destroy();
		this.saySprite = null;
	}
	,shut: function() {
		if(this.saySprite != null) {
			this.sayTimer.cancel();
			this.game.remove(this.saySprite);
			this.saySprite.destroy();
			this.saySprite = null;
	...
	,__class__: org.chaoneurogue.characters.Player
});
org.chaoneurogue.ld31.FlowPhase = $hxClasses["org.chaoneurogue.ld31.FlowPhase"] = { __ename__ : ["org","chaoneurogue","ld31","FlowPhase"], __constructs__ : ["MenuDisplayed","Playing","Dialogue","Transition","Results"] };
org.chaoneurogue.ld31.FlowPhase.MenuDisplayed = ["MenuDisplayed",0];
org.chaoneurogue.ld31.FlowPhase.MenuDisplayed.toString = $estr;
org.chaoneurogue.ld31.FlowPhase.MenuDisplayed.__enum__ = org.chaoneurogue.ld31.FlowPhase;
org.chaoneurogue.ld31.FlowPhase.Playing = ["Playing",1];
org.chaoneurogue.ld31.FlowPhase.Playing.toString = $estr;
org.chaoneurogue.ld31.FlowPhase.Playing.__enum__ = org.chaoneurogue.ld31.FlowPhase;
org.chaoneurogue.ld31.FlowPhase.Dialogue = ["Dialogue",2];
org.chaoneurogue.ld31.FlowPhase.Dialogue.toString = $estr;
org.chaoneurogue.ld31.FlowPhase.Dialogue.__enum__ = org.chaoneurogue.ld31.FlowPhase;
org.chaoneurogue.ld31.FlowPhase.Transition = ["Transition",3];
org.chaoneurogue.ld31.FlowPhase.Transition.toString = $estr;
org.chaoneurogue.ld31.FlowPhase.Transition.__enum__ = org.chaoneurogue.ld31.FlowPhase;
org.chaoneurogue.ld31.FlowPhase.Results = ["Results",4];
org.chaoneurogue.ld31.FlowPhase.Results.toString = $estr;
org.chaoneurogue.ld31.FlowPhase.Results.__enum__ = org.chaoneurogue.ld31.FlowPhase;
org.chaoneurogue.ld31.MenuPhase = $hxClasses["org.chaoneurogue.ld31.MenuPhase"] = { __ename__ : ["org","chaoneurogue","ld31","MenuPhase"], __constructs__ : ["Disabled","IntroScreen","MenuScreen","PauseScreen"] };
org.chaoneurogue.ld31.MenuPhase.Disabled = ["Disabled",0];
org.chaoneurogue.ld31.MenuPhase.Disabled.toString = $estr;
org.chaoneurogue.ld31.MenuPhase.Disabled.__enum__ = org.chaoneurogue.ld31.MenuPhase;
org.chaoneurogue.ld31.MenuPhase.IntroScreen = ["IntroScreen",1];
org.chaoneurogue.ld31.MenuPhase.IntroScreen.toString = $estr;
org.chaoneurogue.ld31.MenuPhase.IntroScreen.__enum__ = org.chaoneurogue.ld31.MenuPhase;
org.chaoneurogue.ld31.MenuPhase.MenuScreen = ["MenuScreen",2];
org.chaoneurogue.ld31.MenuPhase.MenuScreen.toString = $estr;
org.chaoneurogue.ld31.MenuPhase.MenuScreen.__enum__ = org.chaoneurogue.ld31.MenuPhase;
org.chaoneurogue.ld31.MenuPhase.PauseScreen = ["PauseScreen",3];
org.chaoneurogue.ld31.MenuPhase.PauseScreen.toString = $estr;
org.chaoneurogue.ld31.MenuPhase.PauseScreen.__enum__ = org.chaoneurogue.ld31.MenuPhase;
org.chaoneurogue.ld31.PlayState = function(MaxSize) {
	this.gameLost = false;
	this.gameWon = false;
	this.elapsedFadeIn = -1;
	this.fadeInTime = 0.5;
	this.elapsedFadeOut = -1;
	this.fadeOutTime = 0.5;
	this.goalCount = 0;
	flixel.FlxState.call(this,MaxSize);
};
$hxClasses["org.chaoneurogue.ld31.PlayState"] = org.chaoneurogue.ld31.PlayState;
org.chaoneurogue.ld31.PlayState.__name__ = ["org","chaoneurogue","ld31","PlayState"];
org.chaoneurogue.ld31.PlayState.__super__ = flixel.FlxState;
org.chaoneurogue.ld31.PlayState.prototype = $extend(flixel.FlxState.prototype,{
	phase: null
	,nextPhase: null
	,previous: null
	,background: null
	...
	,create: function() {
		...
		this.phase = org.chaoneurogue.ld31.FlowPhase.MenuDisplayed;
		this.nextPhase = null;
		this.previous = null;
		this.world = new org.chaoneurogue.world.World(["level1.tmx","level2.tmx","level3.tmx"]);
		this.startLevel = "level1";
		this.currentLevel = this.startLevel;
		this.transitionTiles = new flixel.group.FlxTypedGroup();
		this.add(this.transitionTiles);
		this.transitionChanges = new Array();
		this.buildLevel(this.startLevel);
		this.menuState = org.chaoneurogue.ld31.MenuPhase.IntroScreen;
		this.intro = new org.chaoneurogue.ui.Intro(0,0,"assets/images/intro.png");
		this.centerUI(this.intro);
		this.add(this.intro);
		this.introTimer = new flixel.util.FlxTimer();
		this.introTimer.start(2,$bind(this,this.onMenu));
		this.menu = new org.chaoneurogue.ui.Menu(this,this.menuState);
		this.centerUI(this.menu);
		this.add(this.menu);
		this.menu.set_visible(false);
		this.menu.set_active(false);
		org.chaoneurogue.world.Entity.paused = true;
		this.viewGameOver = new flixel.FlxSprite(0,0,"assets/images/gameover.png");
		this.centerUI(this.viewGameOver);
		this.viewGameWon = new flixel.FlxSprite(0,0,"assets/images/gamewon.png");
		this.centerUI(this.viewGameWon);
	}
	,centerUI: function(obj) {
		obj.set_x((800 - obj.get_width()) * 0.5);
		obj.set_y((640 - obj.get_height()) * 0.5);
	}
	,destroy: function() {
		flixel.FlxState.prototype.destroy.call(this);
	}
	,update: function() {
		...
		switch(_g[1]) {
		case 0:
			if(this.menuState == org.chaoneurogue.ld31.MenuPhase.IntroScreen) {
				if(flixel.FlxG.keys.justReleased.get_ANY() || flixel.FlxG.mouse._leftButton.justReleased()) {
					flixel.FlxG.sound.play("assets/sounds/click.wav");
					this.onMenu(null);
				}
			} else if(this.menuState == org.chaoneurogue.ld31.MenuPhase.MenuScreen) {
				if(flixel.FlxG.keys.checkStatus(80,flixel.FlxG.keys.justReleased.checkStatus)) {
					flixel.FlxG.sound.play("assets/sounds/click.wav");
					this.onPlay();
					this.player.say(0);
				} else if(flixel.FlxG.keys.checkStatus(88,flixel.FlxG.keys.justReleased.checkStatus)) {
					flixel.FlxG.sound.play("assets/sounds/click.wav");
					this.onExit();
				}
			} else if(this.menuState == org.chaoneurogue.ld31.MenuPhase.PauseScreen) {
				if(flixel.FlxG.keys.checkStatus(80,flixel.FlxG.keys.justReleased.checkStatus)) {
					flixel.FlxG.sound.play("assets/sounds/click.wav");
					this.onPlay();
				}
				if(flixel.FlxG.keys.checkStatus(69,flixel.FlxG.keys.justReleased.checkStatus)) {
					flixel.FlxG.sound.play("assets/sounds/click.wav");
					this.onBackToMenu();
				}
			}
		...
		if(this.nextPhase != null && this.nextPhase != this.phase) this.changePhase(this.nextPhase);
	}
	,updateTransition: function() {
		var delta = flixel.FlxG.elapsed;
		if(this.elapsedFadeOut >= 0) {
			this.elapsedFadeOut += delta;
			if(this.elapsedFadeOut >= this.fadeOutTime) {
				var $it0 = new flixel.group.FlxTypedGroupIterator(this.transitionTiles.members,null);
				while( $it0.hasNext() ) {
					var tile = $it0.next();
					this.remove(tile);
					tile.destroy();
				}
				this.transitionTiles.clear();
				this.remove(this.goal);
				this.goal.destroy();
				this.goal = null;
				var $it1 = new flixel.group.FlxTypedGroupIterator(this.keys.members,null);
				while( $it1.hasNext() ) {
					var key = $it1.next();
					this.remove(key);
					key.destroy();
				...
				this.keys.clear();
				var $it2 = new flixel.group.FlxTypedGroupIterator(this.locks.members,null);
				while( $it2.hasNext() ) {
					var lock = $it2.next();
					this.remove(lock);
					lock.destroy();
				...
				this.locks.clear();
				var $it3 = new flixel.group.FlxTypedGroupIterator(this.enemies.members,null);
				while( $it3.hasNext() ) {
					var enemy = $it3.next();
					this.remove(enemy);
					enemy.destroy();
				...
				this.enemies.clear();
				var $it4 = new flixel.group.FlxTypedGroupIterator(this.ladders.members,null);
				while( $it4.hasNext() ) {
					var ladder = $it4.next();
					this.remove(ladder);
					ladder.destroy();
				...
				this.ladders.clear();
				this.elapsedFadeOut = -1.0;
				var sp = null;
				var _g = 0;
				var _g1 = this.transitionChanges;
				while(_g < _g1.length) {
					var change = _g1[_g];
					++_g;
					sp = this.getSpriteFromTileset(change,32,32);
					if(sp != null) {
						this.add(sp);
						this.transitionTiles.add(sp);
					}
				}
				this.world.loadEntities(this.world.getNextLevel(this.currentLevel),this,["Player"]);
				this.startTilesFadein(this.fadeInTime);
				this.startObjectsFadein(this.fadeInTime);
				this.elapsedFadeIn = 0.0;
			}
		} else if(this.elapsedFadeIn >= 0) {
			this.elapsedFadeIn += delta;
			if(this.elapsedFadeIn >= this.fadeInTime) {
				var _g2 = 0;
				var _g11 = this.transitionChanges;
				while(_g2 < _g11.length) {
					var change1 = _g11[_g2];
					++_g2;
					if(change1.layer == "Level") this.tiles.setTile(change1.col,change1.row,change1.newValue); else if(change1.layer == "Stairs") this.stairs.setTile(change1.col,change1.row,change1.newValue);
				}
				var $it5 = new flixel.group.FlxTypedGroupIterator(this.transitionTiles.members,null);
				while( $it5.hasNext() ) {
					var tile1 = $it5.next();
					tile1.destroy();
				}
				this.transitionTiles.clear();
				var next = this.world.getNextLevel(this.currentLevel);
				if(next != "") {
					this.currentLevel = next;
					null;
				}
				this.player.onStartLevel();
				this.elapsedFadeIn = -1.0;
				this.nextPhase = this.previous;
				this.previous = null;
			}
		}
	}
	,changePhase: function(next) {
		if(next == null) return;
		switch(next[1]) {
		case 1:
			break;
	...
	,buildLevel: function(level) {
		this.background = new flixel.FlxSprite(0,0,"assets/images/bg.png");
		this.add(this.background);
		this.buildTilemap();
		if(this.keys == null) {
			this.keys = new flixel.group.FlxTypedGroup();
			this.add(this.keys);
		}
		if(this.locks == null) {
			this.locks = new flixel.group.FlxTypedGroup();
			this.add(this.locks);
		}
		if(this.enemies == null) {
			this.enemies = new flixel.group.FlxTypedGroup();
			this.add(this.enemies);
		}
		if(this.ladders == null) {
			this.ladders = new flixel.group.FlxTypedGroup();
			this.add(this.ladders);
		}
		this.world.loadEntities(this.currentLevel,this);
	}
	,buildTilemap: function() {
		this.tiles = new org.chaoneurogue.utils.MyFlxTileMap();
		var tileArray = this.world.getTiles(this.currentLevel,"Level");
		var img = this.world.getImage(this.currentLevel);
		var tileWidth = this.world.getTileWidth(this.currentLevel);
		var tileHeight = this.world.getTileHeight(this.currentLevel);
		this.tiles.widthInTiles = this.world.cols;
		this.tiles.heightInTiles = this.world.rows;
		this.tiles.loadMap(tileArray,img,tileWidth,tileHeight,0,1,1,3);
		this.tiles.setTileProperties(1,4369);
		this.tiles.setTileProperties(2,0);
		this.add(this.tiles);
		this.stairs = new org.chaoneurogue.utils.MyFlxTileMap();
		tileArray = this.world.getTiles(this.currentLevel,"Stairs");
		this.stairs.widthInTiles = this.world.cols;
		this.stairs.heightInTiles = this.world.rows;
		this.stairs.loadMap(tileArray,img,tileWidth,tileHeight,0,1,1,3);
		this.stairs.setTileProperties(2,4369);
	...
	,addLadder: function(ladder) {
		this.ladders.add(ladder);
	}
	,onGameWon: function(t) {
		flixel.FlxG.sound.play("assets/sounds/gamewon.wav");
		this.add(this.viewGameWon);
		this.nextPhase = org.chaoneurogue.ld31.FlowPhase.Results;
	}
	,onNextLevel: function() {
		this.previous = this.phase;
		this.player.onNextLevel();
		this.transitionChanges = this.world.getNextChanges(this.currentLevel,["Level","Stairs"]);
		if(this.transitionChanges == null) {
			this.player.say(3);
			this.previous = null;
			this.gameWon = true;
			org.chaoneurogue.world.Entity.paused = true;
			this.goal.startFadeOut(0.8,$bind(this,this.onGameWon));
			return;
		} else {
			this.goalCount++;
			this.player.say(this.goalCount);
			flixel.FlxG.sound.play("assets/sounds/wrongorb.wav");
		}
		var sprite = null;
		var _g = 0;
		var _g1 = this.transitionChanges;
		while(_g < _g1.length) {
			var change = _g1[_g];
			++_g;
			if(change.layer == "Level") sprite = this.tiles.tileToFlxSprite(change.col,change.row); else if(change.layer == "Stairs") sprite = this.stairs.tileToFlxSprite(change.col,change.row);
			this.add(sprite);
			this.transitionTiles.add(sprite);
		}
		this.startTilesFadeout(this.fadeOutTime);
		this.startObjectsFadeout(this.fadeOutTime);
		this.elapsedFadeOut = 0.0;
		this.nextPhase = org.chaoneurogue.ld31.FlowPhase.Transition;
	}
	,startTilesFadeout: function(time) {
		var $it0 = new flixel.group.FlxTypedGroupIterator(this.transitionTiles.members,null);
		while( $it0.hasNext() ) {
			var tile = $it0.next();
			tile.set_alpha(1);
			tile.scale.set(1,1);
			tile.origin.set_x(tile.get_width() / 2);
			tile.origin.set_y(tile.get_height() / 2);
			flixel.tweens.FlxTween.tween(tile,{ alpha : 0},time,{ type : 8, ease : flixel.tweens.FlxEase.backOut});
			flixel.tweens.FlxTween.tween(tile.scale,{ x : 0, y : 0},time,{ type : 8, ease : flixel.tweens.FlxEase.backOut});
		}
	}
	,startObjectsFadeout: function(time) {
		if(this.goal != null) this.goal.startFadeOut(time);
		var $it0 = new flixel.group.FlxTypedGroupIterator(this.keys.members,null);
		while( $it0.hasNext() ) {
			var key = $it0.next();
			key.startFadeOut(time);
		}
		var $it1 = new flixel.group.FlxTypedGroupIterator(this.locks.members,null);
		while( $it1.hasNext() ) {
			var lock = $it1.next();
			lock.startFadeOut(time);
		}
		var $it2 = new flixel.group.FlxTypedGroupIterator(this.enemies.members,null);
		while( $it2.hasNext() ) {
			var enemy = $it2.next();
			enemy.startFadeOut(time);
		}
	}
	,startTilesFadein: function(time) {
		var $it0 = new flixel.group.FlxTypedGroupIterator(this.transitionTiles.members,null);
		while( $it0.hasNext() ) {
			var tile = $it0.next();
			tile.set_alpha(0);
			...
			tile.origin.set_x(tile.get_width() / 2);
			tile.origin.set_y(tile.get_height() / 2);
			flixel.tweens.FlxTween.tween(tile,{ alpha : 1},time,{ type : 8, ease : flixel.tweens.FlxEase.backIn});
			flixel.tweens.FlxTween.tween(tile.scale,{ x : 1, y : 1},time,{ type : 8, ease : flixel.tweens.FlxEase.backIn});
		}
	}
	,startObjectsFadein: function(time) {
		if(this.goal != null) this.goal.startFadeIn(time);
		var $it0 = new flixel.group.FlxTypedGroupIterator(this.keys.members,null);
		while( $it0.hasNext() ) {
			var key = $it0.next();
	...
	,getSpriteFromTileset: function(changeDesc,tileWidth,tileHeight) {
		var oldValue = this.tiles.getTile(changeDesc.col,changeDesc.row);
		if(changeDesc.layer == "Level") {
			this.tiles.setTile(changeDesc.col,changeDesc.row,changeDesc.newValue);
			return this.tiles.tileToFlxSprite(changeDesc.col,changeDesc.row,oldValue);
		} else if(changeDesc.layer == "Stairs") {
			this.stairs.setTile(changeDesc.col,changeDesc.row,changeDesc.newValue);
			return this.stairs.tileToFlxSprite(changeDesc.col,changeDesc.row,oldValue);
		}
		return null;
	}
	,onBackToMenu: function() {
		this.menu.set_visible(this.menu.set_active(false));
		this.onRestart();
		this.onIntro();
	}
	,onRestart: function() {
		...
		this.add(this.menu);
		this.goalCount = 0;
		if(this.gameWon) this.remove(this.viewGameWon);
		if(this.gameLost) this.remove(this.viewGameOver);
		this.gameWon = this.gameLost = false;
		if(this.transitionChanges != null) this.transitionChanges.splice(0,this.transitionChanges.length);
		this.transitionChanges = new Array();
	...
	,removeKey: function(k) {
		this.keys.remove(k,true);
		this.remove(k);
		k.destroy();
	}
	,removeLock: function(l) {
		this.locks.remove(l,true);
		this.remove(l);
		l.destroy();
	}
	,onPlayerDied: function() {
		...
		org.chaoneurogue.world.Entity.paused = true;
		this.nextPhase = org.chaoneurogue.ld31.FlowPhase.Results;
		flixel.FlxG.sound.play("assets/sounds/gameover.wav");
		this.add(this.viewGameOver);
	}
	,onEnemyDied: function(e) {
		this.remove(e);
		this.enemies.remove(e);
		e.destroy();
	}
	,onPlay: function() {
		this.menuState = org.chaoneurogue.ld31.MenuPhase.Disabled;
		flixel.FlxG.mouse.set_visible(false);
		this.intro.set_visible(false);
		this.intro.set_active(false);
		this.menu.set_visible(false);
		this.menu.set_active(false);
		org.chaoneurogue.world.Entity.paused = false;
		this.nextPhase = org.chaoneurogue.ld31.FlowPhase.Playing;
	}
	,onIntro: function() {
		this.intro.set_visible(true);
		this.intro.set_active(true);
		this.menu.set_visible(false);
		this.menu.set_active(false);
		flixel.FlxG.mouse.set_visible(false);
		if(!org.chaoneurogue.world.Entity.paused) org.chaoneurogue.world.Entity.paused = true;
		this.introTimer.start(2,$bind(this,this.onMenu));
		this.nextPhase = org.chaoneurogue.ld31.FlowPhase.MenuDisplayed;
		this.menuState = org.chaoneurogue.ld31.MenuPhase.IntroScreen;
	}
	,onMenu: function(timer) {
		this.intro.set_visible(false);
		this.intro.set_active(false);
		this.menu.set_visible(true);
		this.menu.set_active(true);
		flixel.FlxG.mouse.set_visible(true);
		if(!org.chaoneurogue.world.Entity.paused) org.chaoneurogue.world.Entity.paused = true;
		this.introTimer.cancel();
		this.menuState = org.chaoneurogue.ld31.MenuPhase.MenuScreen;
		this.menu.changeState(this.menuState);
	}
	,onExit: function() {
	}
	,onPause: function() {
		...
		if(!org.chaoneurogue.world.Entity.paused) org.chaoneurogue.world.Entity.paused = true;
		this.nextPhase = org.chaoneurogue.ld31.FlowPhase.MenuDisplayed;
		this.menuState = org.chaoneurogue.ld31.MenuPhase.PauseScreen;
		this.menu.set_active(this.menu.set_visible(true));
		this.menu.changeState(this.menuState);
	}
	,__class__: org.chaoneurogue.ld31.PlayState
});
org.chaoneurogue.ui = {};
org.chaoneurogue.ui.Intro = function(X,Y,gfx) {
	if(Y == null) Y = 0;
	if(X == null) X = 0;
	flixel.FlxSprite.call(this,X,Y,gfx);
};
$hxClasses["org.chaoneurogue.ui.Intro"] = org.chaoneurogue.ui.Intro;
org.chaoneurogue.ui.Intro.__name__ = ["org","chaoneurogue","ui","Intro"];
org.chaoneurogue.ui.Intro.__super__ = flixel.FlxSprite;
org.chaoneurogue.ui.Intro.prototype = $extend(flixel.FlxSprite.prototype,{
	__class__: org.chaoneurogue.ui.Intro
});
org.chaoneurogue.ui.Menu = function(game,menuState,X,Y,MaxSize) {
	if(MaxSize == null) MaxSize = 0;
	if(Y == null) Y = 0;
	if(X == null) X = 0;
	flixel.group.FlxSpriteGroup.call(this,X,Y,MaxSize);
	this.game = game;
	this.bg = new flixel.FlxSprite(0,0,"assets/images/menu_bg.png");
	this.add(this.bg);
	this.play = new flixel.ui.FlxButton(32,32,"",$bind(this,this.onPlayClick));
	this.play.loadGraphic("assets/images/btn_play.png");
	this.add(this.play);
	this.menu = new flixel.ui.FlxButton(0,0,"",$bind(this,this.onMenuClick));
	this.menu.loadGraphic("assets/images/btn_menu.png");
	this.mute = new flixel.ui.FlxButton(32,128,"",$bind(this,this.onToggleSoundClick));
	this.mute.loadGraphic("assets/images/btn_mute.png");
	this.info = new flixel.FlxSprite(this.bg.get_width() - 172,304,"assets/images/info.png");
	this.add(this.info);
	this.changeState(menuState);
};
$hxClasses["org.chaoneurogue.ui.Menu"] = org.chaoneurogue.ui.Menu;
org.chaoneurogue.ui.Menu.__name__ = ["org","chaoneurogue","ui","Menu"];
org.chaoneurogue.ui.Menu.__super__ = flixel.group.FlxSpriteGroup;
org.chaoneurogue.ui.Menu.prototype = $extend(flixel.group.FlxSpriteGroup.prototype,{
	menuState: null
	,game: null
	,bg: null
	,play: null
	...
	,changeState: function(newState) {
		...
		if(this.menuState == org.chaoneurogue.ld31.MenuPhase.PauseScreen) {
			this.menu.setPosition(32,128);
			this.add(this.menu);
			this.remove(this.quitButton);
		}
		if(this.menuState == org.chaoneurogue.ld31.MenuPhase.MenuScreen) {
			this.quitButton.setPosition(32,128);
	...
	,__class__: org.chaoneurogue.ui.Menu
});
org.chaoneurogue.utils = {};
org.chaoneurogue.utils.MyFlxTileMap = function() {
	flixel.tile.FlxTilemap.call(this);
};
$hxClasses["org.chaoneurogue.utils.MyFlxTileMap"] = org.chaoneurogue.utils.MyFlxTileMap;
org.chaoneurogue.utils.MyFlxTileMap.__name__ = ["org","chaoneurogue","utils","MyFlxTileMap"];
org.chaoneurogue.utils.MyFlxTileMap.__super__ = flixel.tile.FlxTilemap;
org.chaoneurogue.utils.MyFlxTileMap.prototype = $extend(flixel.tile.FlxTilemap.prototype,{
	getTileObjects: function() {
		return this._tileObjects;
	}
	,getStairs: function(g) {
		var _g = 0;
		var _g1 = this._data;
		while(_g < _g1.length) {
			var id = _g1[_g];
	...
	,__class__: org.chaoneurogue.utils.MyFlxTileMap
});
org.chaoneurogue.utils.MyTexturePackerData = function(Description,AssetName) {
	flixel.util.loaders.TexturePackerData.call(this,Description,AssetName);
};
$hxClasses["org.chaoneurogue.utils.MyTexturePackerData"] = org.chaoneurogue.utils.MyTexturePackerData;
org.chaoneurogue.utils.MyTexturePackerData.__name__ = ["org","chaoneurogue","utils","MyTexturePackerData"];
org.chaoneurogue.utils.MyTexturePackerData.__super__ = flixel.util.loaders.TexturePackerData;
org.chaoneurogue.utils.MyTexturePackerData.prototype = $extend(flixel.util.loaders.TexturePackerData.prototype,{
	getFrameRectangle: function(name) {
		var _g = 0;
		var _g1 = this.frames;
		while(_g < _g1.length) {
			var frame = _g1[_g];
			++_g;
			if(frame.name == name) return frame.frame;
		}
		return null;
	}
	,__class__: org.chaoneurogue.utils.MyTexturePackerData
});
org.chaoneurogue.world.ChangeDescriptor = function(layer,row,col,newValue) {
	this.row = row;
	this.col = col;
	this.layer = layer;
	this.newValue = newValue;
};
$hxClasses["org.chaoneurogue.world.ChangeDescriptor"] = org.chaoneurogue.world.ChangeDescriptor;
org.chaoneurogue.world.ChangeDescriptor.__name__ = ["org","chaoneurogue","world","ChangeDescriptor"];
org.chaoneurogue.world.ChangeDescriptor.prototype = {
	col: null
	,row: null
	,newValue: null
	,layer: null
	,__class__: org.chaoneurogue.world.ChangeDescriptor
};
org.chaoneurogue.world.World = function(levelList) {
	this.TILESET = "level";
	this.cols = 25;
	this.rows = 20;
	var this1;
	this1 = new Array(levelList.length);
	this.sequence = this1;
	this.mapData = new Array();
	var idx = 0;
	var _g = 0;
	while(_g < levelList.length) {
		var item = levelList[_g];
		++_g;
		var val = item.substring(0,item.indexOf(".tmx"));
		this.sequence[idx] = val;
		this.mapData.push(new flixel.addons.editors.tiled.TiledMap("assets/data/" + item));
		idx++;
	}
	this.generateChangelists();
};
$hxClasses["org.chaoneurogue.world.World"] = org.chaoneurogue.world.World;
org.chaoneurogue.world.World.__name__ = ["org","chaoneurogue","world","World"];
org.chaoneurogue.world.World.prototype = {
	rows: null
	,cols: null
	,sequence: null
	,changeLists: null
	...
	,TILESET: null
	,getRow: function(idx) {
		if(idx < 0 || idx >= this.rows * this.cols) return -1; else return Math.floor(idx / this.cols);
	}
	,getCol: function(idx) {
		if(idx < 0 || idx >= this.rows * this.cols) return -1; else return Math.floor(idx % this.cols);
	}
	,generateChangelists: function() {
		this.changeLists = new haxe.ds.StringMap();
		var idx = 0;
		var cur = null;
		var next = null;
		while(idx < this.sequence.length - 1) {
			cur = this.mapData[idx];
			next = this.mapData[idx + 1];
			var v = this.getChangeLists(cur,next,["Level","Stairs"],["Items"]);
			this.changeLists.set(this.sequence[idx],v);
			v;
			idx++;
		}
	}
	,getChangeLists: function(cur,next,layerNames,objectGroupNames) {
		var levelChanges = new haxe.ds.StringMap();
		var layer1;
		var layer2;
		var numTiles1;
		var numTiles2;
		...
		while(_g < layerNames.length) {
			...
			numTiles1 = layer1.get_tileArray().length;
			numTiles2 = layer2.get_tileArray().length;
			if(numTiles1 != numTiles2) continue;
			var idx = 0;
			while(idx < numTiles1) {
				if(layer1.get_tileArray()[idx] != layer2.get_tileArray()[idx]) levelChanges.get(name).push(new org.chaoneurogue.world.ChangeDescriptor(name,this.getRow(idx),this.getCol(idx),layer2.get_tileArray()[idx]));
				idx++;
			}
		}
		return levelChanges;
	}
	,getIndex: function(mapId) {
		var i = 0;
		while(i < this.sequence.length) {
			if(this.sequence[i] == mapId) return i;
			i++;
		}
		return -1;
	}
	,getTiles: function(mapId,layerId) {
		var mapIdx = this.getIndex(mapId);
		if(mapIdx == -1) return null;
		return this.mapData[mapIdx].getLayer(layerId).get_tileArray();
	}
	,getImage: function(mapId) {
		var mapIdx = this.getIndex(mapId);
		if(mapIdx == -1) return null;
		var tileSet = this.mapData[mapIdx].getTileSet(this.TILESET);
		var imagePath = new haxe.io.Path(tileSet.imageSource);
		var processedPath = "assets/images/" + imagePath.file + "." + imagePath.ext;
		return processedPath;
	}
	,getTileWidth: function(mapId) {
		var mapIdx = this.getIndex(mapId);
		if(mapIdx == -1) return 32;
		var tileSet = this.mapData[mapIdx].getTileSet(this.TILESET);
		return tileSet.tileWidth;
	}
	,getTileHeight: function(mapId) {
		var mapIdx = this.getIndex(mapId);
		if(mapIdx == -1) return 32;
		var tileSet = this.mapData[mapIdx].getTileSet(this.TILESET);
		return tileSet.tileHeight;
	}
	,getNextChanges: function(mapId,layers) {
		if(!this.changeLists.exists(mapId)) return null;
		var changeResults = new Array();
		var _g = 0;
		while(_g < layers.length) {
			...
			if((function($this) {
				var $r;
				var this1 = $this.changeLists.get(mapId);
				$r = this1.exists(name);
				return $r;
			}(this))) changeResults = changeResults.concat((function($this) {
				var $r;
				var this2 = $this.changeLists.get(mapId);
				$r = this2.get(name);
				return $r;
			}(this)));
		}
	...
	,getNextLevel: function(mapId) {
		var idx = this.getIndex(mapId);
		if(idx >= 0 && idx < this.sequence.length - 1) return this.sequence[idx + 1];
		return "";
	}
	,loadEntities: function(level,game,ignore) {
		var mapIdx = this.getIndex(level);
		if(mapIdx == -1) return;
		var types = ["Player","Key","Lock","Goal","Enemy","LadderTop"];
		var classes = ["org.chaoneurogue.characters.Player","org.chaoneurogue.world.items.Key","org.chaoneurogue.world.items.Lock","org.chaoneurogue.world.items.Goal","org.chaoneurogue.characters.Enemy","org.chaoneurogue.world.items.LadderTop"];
		var objects = this.mapData[mapIdx].getObjectGroup("Items").objects;
		var classInstance;
		var i = 0;
		var c;
		var _g = 0;
		while(_g < objects.length) {
			...
			while(i < types.length) {
				if((ignore == null || HxOverrides.indexOf(ignore,obj.type,0) == -1) && obj.type == types[i]) {
	...
	,__class__: org.chaoneurogue.world.World
};
org.chaoneurogue.world.items = {};
org.chaoneurogue.world.items.Goal = function(X,Y,SimpleGraphic) {
	if(Y == null) Y = 0;
	if(X == null) X = 0;
	org.chaoneurogue.world.Entity.call(this,X,Y,SimpleGraphic);
};
$hxClasses["org.chaoneurogue.world.items.Goal"] = org.chaoneurogue.world.items.Goal;
org.chaoneurogue.world.items.Goal.__name__ = ["org","chaoneurogue","world","items","Goal"];
org.chaoneurogue.world.items.Goal.__super__ = org.chaoneurogue.world.Entity;
org.chaoneurogue.world.items.Goal.prototype = $extend(org.chaoneurogue.world.Entity.prototype,{
	resolveWorld: function() {
		this.game.setGoal(this);
	}
	,__class__: org.chaoneurogue.world.items.Goal
});
org.chaoneurogue.world.items.Key = function(X,Y,SimpleGraphic) {
	if(Y == null) Y = 0;
	if(X == null) X = 0;
	this.lockName = null;
	org.chaoneurogue.world.Entity.call(this,X,Y,SimpleGraphic);
};
$hxClasses["org.chaoneurogue.world.items.Key"] = org.chaoneurogue.world.items.Key;
org.chaoneurogue.world.items.Key.__name__ = ["org","chaoneurogue","world","items","Key"];
org.chaoneurogue.world.items.Key.__super__ = org.chaoneurogue.world.Entity;
org.chaoneurogue.world.items.Key.prototype = $extend(org.chaoneurogue.world.Entity.prototype,{
	lockName: null
	,load: function(obj,game) {
		org.chaoneurogue.world.Entity.prototype.load.call(this,obj,game);
		this.lockName = this.tiledObj.custom.keys.get("lock");
	}
	,resolveWorld: function() {
		this.game.addKey(this);
	}
	,__class__: org.chaoneurogue.world.items.Key
});
org.chaoneurogue.world.items.LadderTop = function(X,Y,SimpleGraphic) {
	if(Y == null) Y = 0;
	if(X == null) X = 0;
	org.chaoneurogue.world.Entity.call(this,X,Y,SimpleGraphic);
...
$hxClasses["org.chaoneurogue.world.items.LadderTop"] = org.chaoneurogue.world.items.LadderTop;
org.chaoneurogue.world.items.LadderTop.__name__ = ["org","chaoneurogue","world","items","LadderTop"];
org.chaoneurogue.world.items.LadderTop.__super__ = org.chaoneurogue.world.Entity;
org.chaoneurogue.world.items.LadderTop.prototype = $extend(org.chaoneurogue.world.Entity.prototype,{
	load: function(obj,game) {
		this.tiledObj = obj;
		this.name = obj.name;
		this.game = game;
		this.makeGraphic(obj.width,obj.height,0);
		this.updateFrameData();
		this.setPosition(obj.x,obj.y);
		this.resolveWorld();
	}
	,resolveWorld: function() {
		this.game.addLadder(this);
	}
	,__class__: org.chaoneurogue.world.items.LadderTop
});
org.chaoneurogue.world.items.Lock = function(X,Y,SimpleGraphic) {
	if(Y == null) Y = 0;
	if(X == null) X = 0;
	org.chaoneurogue.world.Entity.call(this,X,Y,SimpleGraphic);
	this.set_immovable(true);
};
$hxClasses["org.chaoneurogue.world.items.Lock"] = org.chaoneurogue.world.items.Lock;
org.chaoneurogue.world.items.Lock.__name__ = ["org","chaoneurogue","world","items","Lock"];
org.chaoneurogue.world.items.Lock.__super__ = org.chaoneurogue.world.Entity;
org.chaoneurogue.world.items.Lock.prototype = $extend(org.chaoneurogue.world.Entity.prototype,{
	resolveWorld: function() {
		this.game.addLock(this);
	}
	,__class__: org.chaoneurogue.world.items.Lock
});
...
ApplicationMain.config = { antialiasing : 0, background : 0, borderless : false, depthBuffer : false, fps : 60, fullscreen : false, height : 640, orientation : "portrait", resizable : true, stencilBuffer : false, title : "LD 31", vsync : true, width : 800};
...
flixel.effects.FlxSpriteFilter.helperRect = new flash.geom.Rectangle();
flixel.effects.FlxSpriteFilter.helperPoint = new flash.geom.Point();
...
org.chaoneurogue.world.Entity.gravity = 420;
org.chaoneurogue.world.Entity.paused = false;
